...
///
/// Locales: 10
/// Strings: 2974 (297 per locale)
///
/// Built on 2025-02-27 at 09:16 UTC
...
class TranslationsConfigFa extends TranslationsConfigEn {
	...
	@override String get blockAds => 'مسدود سازی تبلیغات';
...
class TranslationsSettingsZhTw extends TranslationsSettingsEn {
	...
	@override String get exportAllOptions => '匯出選項至剪貼簿(用於偵錯) ';
	@override String get importOptions => '從剪貼簿匯入選項';
	@override String get importOptionsMsg => '這將使用提供的值複寫所有配置選項。您確定嗎？';
...
class TranslationsAppUpdateZhTw extends TranslationsAppUpdateEn {
	...
	@override String get dialogTitle => '有可用更新';
	@override String get updateMsg => '${_root.general.appTitle} 的更新版本現已推出。您想立即更新嗎？';
	@override String get currentVersionLbl => '目前版本';
	@override String get newVersionLbl => '新版本';
	@override String get updateNowBtnTxt => '立即更新';
	@override String get laterBtnTxt => '稍後再說';
	@override String get ignoreBtnTxt => '忽略';
}
...
class TranslationsProfileAddZhTw extends TranslationsProfileAddEn {
	...
	@override String get addWarp => '添加 WARP';
	@override String get addingWarpMsg => '我們正在註冊 WARP，請稍候。';
...
extension on TranslationsFa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'config.blockAds': return 'مسدود سازی تبلیغات';
...
extension on TranslationsZhTw {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'profile.add.addWarp': return '添加 WARP';
			case 'profile.add.addingWarpMsg': return '我們正在註冊 WARP，請稍候。';
			...
			case 'settings.exportAllOptions': return '匯出選項至剪貼簿(用於偵錯) ';
			case 'settings.importOptions': return '從剪貼簿匯入選項';
			case 'settings.importOptionsMsg': return '這將使用提供的值複寫所有配置選項。您確定嗎？';
			...
			case 'appUpdate.dialogTitle': return '有可用更新';
			case 'appUpdate.updateMsg': return '${_root.general.appTitle} 的更新版本現已推出。您想立即更新嗎？';
			case 'appUpdate.currentVersionLbl': return '目前版本';
			case 'appUpdate.newVersionLbl': return '新版本';
			case 'appUpdate.updateNowBtnTxt': return '立即更新';
			case 'appUpdate.laterBtnTxt': return '稍後再說';
			case 'appUpdate.ignoreBtnTxt': return '忽略';
